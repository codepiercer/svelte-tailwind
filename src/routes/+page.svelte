...
<main class="grid h-screen place-items-center">
  <div class="flex flex-col items-center gap-4 text-center font-bold">
    <img src="/favicon.png" alt="logo of file cabinet representing components" class="h-16 w-16" />
    <h1 class="text-5xl tracking-tight text-indigo-600">Svelte Tailwind</h1>
    <h2 class="text-lg text-gray-500">
      A collection of reusable <a
        href="https://svelte.dev/"
        target="_blank"
        rel="noreferrer"
        class="font-medium text-red-600 hover:text-red-700">svelte</a
      >
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        class="font-medium text-red-600 hover:text-red-700">tailwind css</a
      >
    </h2>
